...
{
    namespace Host_UDP_Report_Time_Host_XamlTypeInfo
    {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::Host_UDP_Report_Time_Host::Host_UDP_Report_Time_Host_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::Host_UDP_Report_Time_Host::Host_UDP_Report_Time_Host_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::Host_UDP_Report_Time_Host::Host_UDP_Report_Time_Host_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::Host_UDP_Report_Time_Host::Host_UDP_Report_Time_Host_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
