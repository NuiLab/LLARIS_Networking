...
{
    namespace HL2_UDP_Report_Time_Client_XamlTypeInfo
    {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::HL2_UDP_Report_Time_Client::HL2_UDP_Report_Time_Client_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::HL2_UDP_Report_Time_Client::HL2_UDP_Report_Time_Client_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::HL2_UDP_Report_Time_Client::HL2_UDP_Report_Time_Client_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::HL2_UDP_Report_Time_Client::HL2_UDP_Report_Time_Client_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
